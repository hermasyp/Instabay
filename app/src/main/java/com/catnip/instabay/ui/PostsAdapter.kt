...
import com.catnip.instabay.R
import com.catnip.instabay.databinding.ItemPostBinding
import com.catnip.instabay.model.Post

/**
Written with love by Muhammad Hermas Yuda Pamungkas
Github : https://github.com/hermasyp
 **/
class PostsAdapter(private val itemClick: (Post) -> Unit) :
    ...
    class PostViewHolder(private val binding: ItemPostBinding, val itemClick: (Post) -> Unit) :
        ...
        fun bindView(item: Post) {
            with(item) {
                ...
                binding.tvImageTag.text = item.type.orEmpty()
